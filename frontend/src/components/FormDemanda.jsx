...
export default function FormDemanda() {
  ...
  return (
    <section className="mt-14 rounded-2xl border border-slate-200 bg-gradient-to-br from-slate-50 to-white p-6 shadow-sm sm:p-8">
        ...
        {sucesso ? (
          <div className="mt-8 flex flex-col items-center gap-3 py-10 text-center">
            ...
            <p className="max-w-md text-sm text-slate-600">
              Recebemos seu pedido e entraremos em contato assim que encontrarmos
              um imóvel com esse perfil.
            </p>
            <button
              type="button"
          ...
          <form onSubmit={submeter} className="mt-6 grid gap-4 sm:grid-cols-2">
            <div>
